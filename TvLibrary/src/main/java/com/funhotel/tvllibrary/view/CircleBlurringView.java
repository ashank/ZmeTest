...
import com.funhotel.tvllibrary.utils.DeviceUtil;

/**
 * 高斯模糊View，详情见 https://github.com/500px/500px-android-blur
 ...
 */
public class CircleBlurringView extends View {

    private DeviceUtil deviceUtil;

    public CircleBlurringView(Context context) {
        this(context, null);
    }

    public CircleBlurringView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBlurredView != null) {
            if (prepare()) {
                ...
                mBitmapShader = new BitmapShader(mBlurredBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
                mBitmapPaint = new Paint();
                mBitmapPaint.setAntiAlias(true);
                mBitmapPaint.setShader(mBitmapShader);
                canvas.drawCircle(getResources().getDimension(R.dimen.px_75), getResources().getDimension(R.dimen.px87), getResources().getDimension(R.dimen.px169), mBitmapPaint);
                canvas.restore();
            }
