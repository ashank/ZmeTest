...
public class OutlineContainer extends FrameLayout implements Animatable {
    ...
    private void init() {
        ...
        mOutlinePaint.setStrokeWidth(DeviceUtil.dpToPx(getResources(), 2));
        mOutlinePaint.setColor(getResources().getColor(R.color.CFFFFFF));
        mOutlinePaint.setStyle(Style.STROKE);

        int padding = DeviceUtil.dpToPx(getResources(), 10);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int offset = DeviceUtil.dpToPx(getResources(), 5);
