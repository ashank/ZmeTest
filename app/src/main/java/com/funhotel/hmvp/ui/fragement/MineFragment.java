...
import com.funhotel.hmvp.ui.activity.LoginActivity;
import com.funhotel.hmvp.ui.activity.RegistActivity;
...
public class MineFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ivUserPhpto = view.findViewById(R.id.touxiang);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Glide.with(this).load("http://img.zcool.cn/community/014f5857e5038d0000012e7e543562.jpg@900w_1l_2o_100sh"
                + ".jpg").into(ivUserPhpto);
