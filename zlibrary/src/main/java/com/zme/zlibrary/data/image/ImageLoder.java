package com.zme.zlibrary.data.image;
...
import com.zme.zlibrary.utils.DisplayUtils;
        ...
        Glide.with(weakReference.get())
                ...
                .transform(new CenterCrop(weakReference.get()),
                        new RoundedCornersTransformation(weakReference.get(),
                                DisplayUtils.dp2px(weakReference.get(),
                                        radius), 0))
                .error(placeholder)//加载错误图
                .placeholder(placeholder)//设置占位图
                .into(imageView);
        ...
        Glide.with(context.getApplicationContext())
                ...
                .listener(new RequestListener<String, GlideDrawable>() {
                    ...
                    public boolean onResourceReady(GlideDrawable resource, String model, Target<GlideDrawable> target, boolean isFromMemoryCache, boolean isFirstResource) {
                        ...
                        if (null != bm) {
                            LogUtils.i(TAG + " getHeight = " + bm.getHeight());
                            LogUtils.i(TAG + " getWidth = " + bm.getWidth());
                        } else {
                            LogUtils.i(TAG + " ============null============");
                        }
