...
public class AdvancedWebView extends WebView {
    ...
    public interface Listener {
        ...
        void onDownloadRequested(String url, String userAgent, String contentDisposition,
    ...
    protected void init(Context context) {
        ...
        final String appCaceDir = context.getDir("cache", Context.MODE_PRIVATE).getPath();
        ...
        // 支持JS的交互
        //4.1系统加载网页时出现IllegalArgumentException
        try {
        ...
        webSettings.setAppCacheMaxSize(1024 * 1024 * 8); //缓存最多可以有8M
...
//
    ...
    public static class Browsers {
        ...
        public static String getAlternative(final Context context) {
            ...
            final List<ApplicationInfo> apps = context.getPackageManager().getInstalledApplications(
