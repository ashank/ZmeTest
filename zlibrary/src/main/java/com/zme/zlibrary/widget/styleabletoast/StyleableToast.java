...
public class StyleableToast implements OnToastFinished {
    ...
    private View getToastLayout() {
        ...
        int horizontalPadding = (int) Utils.getTypedValueInDP(context, DEFAULT_HORIZONTAL_PADDING);
        int verticalPadding = (int) Utils.getTypedValueInDP(context, DEFAULT_VERTICAL_PADDING);
    ...
    private TextView getTextView() {
        ...
        if (drawable > 0) {
            ...
            //previous: 18x2  + 8
            int leftPadding = (int) Utils.getTypedValueInDP(context, 18 * 2 + 5);
            int rightPadding = (int) Utils.getTypedValueInDP(context, 22);
    ...
    private ImageView getIcon() {
        ...
        if (drawable > 0) {
            ...
            //previous 18:
            int marginLeft = (int) Utils.getTypedValueInDP(context, 15);
            int maxHeightVal = (int) Utils.getTypedValueInDP(context, 20);
            int maxWidthVal = (int) Utils.getTypedValueInDP(context, 20);
    ...
    private float getStrokeWidth() {
        return Utils.getTypedValueInDP(context, strokeWidth);
    }
    ...
    private float getShapeCornerRadius() {
        if (cornerRadius >= 0) {
            return Utils.getTypedValueInDP(context, cornerRadius);
        } else {
            return Utils.getTypedValueInDP(context, DEFAULT_CORNER_RADIUS);
        }
    }
